...
<template>
    <h2 id="contacto" class="after-effect after:left-48 font-semibold">Contacto</h2>

    <div
        class="p-4 md:p-8 dark:border-[#212425] dark:border-2 bg-color-810 rounded-xl dark:bg-[#111111] mb-[1px] md:mb-[12px]">
        <form action="https://formsubmit.co/5f6dc3996619117e669d938db5d4297e" method="POST">
            <div class="returnmessage" data-success="Your message has been received, We will contact you soon."></div>
            <div class="empty_notice">
                <span class="text-[#CA56F2]">Por favor llene los campos marcados</span>
            </div>
            ...
            <!-- submit buttons -->
            <input type="submit"
                class="px-6 py-2 rounded-lg border-[2px] mt-3 border-color-910 font-semibold cursor-pointer hover:bg-gradient-to-r from-[#7a579f] to-[#5E17EB] hover:text-white transition-colors duration-300 ease-in-out hover:border-transparent dark:text-white"
                value="Enviar" />
    ...
    <div class="block p-4 md:p-8">
        <a class="px-4 py-2 bg-[#25d366] rounded-full"
            href="https://api.whatsapp.com/send/?phone=59170239101&text=Hola+imer+te+escribo+para+..." target="_blank">
            <i class="fa-brands fa-whatsapp text-white"></i>
            <span class="text-white">&nbsp;Whatsapp</span>
        </a>
        <a class="ml-4 px-4 py-2 bg-[#3487f1] rounded-full" href="https://telegram.me/Sabio24" target="_blank">
